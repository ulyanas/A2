 ...
 * @author user
 */
public class OrderLoginJFrame extends javax.swing.JFrame {

    /**
     * Creates new form InventoryLoginJFrame
     */
    public OrderLoginJFrame() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OrderLoginJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OrderLoginJFrame().setVisible(true);
            }
        });
    }
