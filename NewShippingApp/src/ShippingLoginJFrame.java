 ...
 * @author user
 */
public class ShippingLoginJFrame extends javax.swing.JFrame {

    /**
     * Creates new form ShippingLoginJFrame
     */
    public ShippingLoginJFrame() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("New Shipping Management Application");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ShippingLoginJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ShippingLoginJFrame().setVisible(true);
            }
        });
    }
